...
from mycar import dellcar as dk

from parts.datastore import TubGroup, TubWriter
from parts.transform import Lambda
from parts.simulation import SquareBoxCamera
...
def train(cfg, tub_names, model_name):
    ...
    def rt(record):
        record['user/angle'] = dellcar.utils.utils.linear_bin(record['user/angle'])
        return record
